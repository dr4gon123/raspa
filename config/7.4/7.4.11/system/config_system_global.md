...
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-unified-mem        | Maximum unified memory allowed in | integer                   | Minimum value: 168438865  | 842194329 \*\*               |
|                                          | user device store.                |                           | Maximum value: 1684388659 |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
