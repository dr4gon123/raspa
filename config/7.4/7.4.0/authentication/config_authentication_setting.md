...
+--------------------------+------------------------------------+--------------------+--------------------+--------------------+
| captive-portal-port      | Captive portal port number.        | integer            | Minimum value: 1   | 7830               |
|                          |                                    |                    | Maximum value:     |                    |
|                          |                                    |                    | 65535              |                    |
+--------------------------+------------------------------------+--------------------+--------------------+--------------------+
...
|                          | maximum age in minutes.            |                    | Maximum value:     |                    |
|                          |                                    |                    | 10080              |                    |
+--------------------------+------------------------------------+--------------------+--------------------+--------------------+
| cookie-refresh-div       | Refresh rate divider of persistent | integer            | Minimum value: 2   | 2                  |
|                          | web portal cookie. Refresh value = |                    | Maximum value: 4   |                    |
