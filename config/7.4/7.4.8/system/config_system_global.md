...
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-unified-mem        | Maximum unified memory allowed in | integer                   | Minimum value: 168439685  | 842198425 \*\*               |
|                                          | user device store.                |                           | Maximum value: 1684396851 |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
