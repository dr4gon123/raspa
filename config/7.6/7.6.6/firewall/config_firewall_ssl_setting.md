...
|                                  | 10).                              |                    |                    |                    |
+----------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| cert-manager-cache-timeout       | Time limit for certificate        | integer            | Minimum value: 24  | 72                 |
|                                  | manager to keep FortiGate         |                    | Maximum value: 720 |                    |
|                                  | re-signed server certificate      |                    |                    |                    |
...
|                                  | default = 30).                    |                    |                    |                    |
+----------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| resigned-short-lived-certificate | Enable/disable short-lived        | option             | \-                 | enable             |
|                                  | certificate.                      |                    |                    |                    |
+----------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
|                                  | +-------------+--------------------------------------------------------+                         |
|                                  | | Option      | Description                                            |                         |
|                                  | +=============+========================================================+                         |
|                                  | | *enable*    | Enable short-lived certificate: re-signed certificate  |                         |
|                                  | |             | will remain valid until either the origin server       |                         |
|                                  | |             | ceritificate expires or cache timeouts.                |                         |
|                                  | +-------------+--------------------------------------------------------+                         |
|                                  | | *disable*   | Disable short-lived certificate: re-signed certificate |                         |
|                                  | |             | will have the same validation period as the origin     |                         |
|                                  | |             | server ceritificate.                                   |                         |
|                                  | +-------------+--------------------------------------------------------+                         |
+----------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
