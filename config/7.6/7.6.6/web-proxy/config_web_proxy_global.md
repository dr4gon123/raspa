...
|                                   | +-------------+--------------------------------------------------------+                                  |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| auth-sign-timeout                 | Proxy auth query sign timeout in  | integer               | Minimum value: 30     | 120                   |
|                                   | seconds (30 - 3600, default =     |                       | Maximum value: 3600   |                       |
|                                   | 120).                             |                       |                       |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
...
|                                   | (6 - 60 min, default = 30).       |                       |                       |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| http2-client-window-size          | HTTP/2 client initial window size | integer               | Minimum value: 65535  | 1048576               |
|                                   | in bytes (65535 - 2147483647,     |                       | Maximum value:        |                       |
|                                   | default = 1048576 (1MB)).         |                       | 2147483647            |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| http2-server-window-size          | HTTP/2 server initial window size | integer               | Minimum value: 65535  | 1048576               |
|                                   | in bytes (65535 - 2147483647,     |                       | Maximum value:        |                       |
|                                   | default = 1048576 (1MB)).         |                       | 2147483647            |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
...
|                                   | 8).                               |                       |                       |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| max-waf-body-cache-length         | Maximum length of HTTP messages   | integer               | Minimum value: 1      | 1                     |
|                                   | processed by Web Application      |                       | Maximum value: 1024   |                       |
|                                   | Firewall (WAF) (1 - 1024 Kbytes,  |                       |                       |                       |
|                                   | default = 1).                     |                       |                       |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| policy-partial-match              | Enable/disable policy partial     | option                | \-                    | enable                |
|                                   | matching.                         |                       |                       |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
|                                   | +-------------+--------------------------------------------------------+                                  |
|                                   | | Option      | Description                                            |                                  |
...
|                                   | +-------------+--------------------------------------------------------+                                  |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| proxy-fqdn                        | Fully Qualified Domain Name of    | string                | Maximum length: 255   | default.fqdn          |
|                                   | the explicit web proxy (default = |                       |                       |                       |
|                                   | default.fqdn) that clients        |                       |                       |                       |
|                                   | connect to.                       |                       |                       |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
...
|                                   | +-------------+--------------------------------------------------------+                                  |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| request-obs-fold                  | Action when HTTP/1.x request      | option                | \-                    | keep                  |
|                                   | header contains obs-fold (default |                       |                       |                       |
|                                   | = keep).                          |                       |                       |                       |
+-----------------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
|                                   | +-------------------+--------------------------------------------------------+                            |
|                                   | | Option            | Description                                            |                            |
|                                   | +===================+========================================================+                            |
|                                   | | *replace-with-sp* | Replace CRLF in obs-fold with SP in the request header |                            |
|                                   | |                   | for HTTP/1.x.                                          |                            |
|                                   | +-------------------+--------------------------------------------------------+                            |
|                                   | | *block*           | Block HTTP/1.x request with obs-fold.                  |                            |
|                                   | +-------------------+--------------------------------------------------------+                            |
|                                   | | *keep*            | Keep obs-fold in the request header for HTTP/1.x.      |                            |
