...
+---------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| session-ttl         | Session TTL (300 - 2764800, 0 =   | user                  | Not Specified         |                                      |
|                     | default).                         |                       |                       |                                      |
+---------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
...
|                     | state in seconds (5 - 300 sec, 0  |                       | Maximum value: 300    |                                      |
|                     | = default).                       |                       |                       |                                      |
+---------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| tcp-timewait-timer  | Set the length of the TCP         | integer               | Minimum value: 0      | 0                                    |
|                     | TIME-WAIT state in seconds (1 -   |                       | Maximum value: 300    |                                      |
|                     | 300 sec, 0 = default).            |                       |                       |                                      |
+---------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| udp-idle-timer      | Number of seconds before an idle  | integer               | Minimum value: 0      | 0                                    |
|                     | UDP/UDP-Lite connection times out |                       | Maximum value: 86400  |                                      |
|                     | (0 - 86400 sec, 0 = default).     |                       |                       |                                      |
+---------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
