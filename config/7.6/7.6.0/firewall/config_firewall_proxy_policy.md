...
|                                | accepted by this policy (0 means  |                       | Maximum value:        |                                      |
|                                | use the system default session    |                       | 2764800               |                                      |
|                                | TTL).                             |                       |                       |                                      |
+--------------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
...
|                                | EMS Tag name.                     |                       |                       |                                      |
+--------------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| ztna-proxy `<name>`            | IPv4 ZTNA traffic forward proxy.  | string                | Maximum length: 79    |                                      |
|                                |                                   |                       |                       |                                      |
