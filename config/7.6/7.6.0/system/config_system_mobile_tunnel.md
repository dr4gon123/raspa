...
|                   | lifetime (180 - 65535 sec,        |                    | Maximum value:     |                    |
|                   | default = 65535).                 |                    | 65535              |                    |
+-------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                   | +-------------+--------------------------------------------------------+                         |
+-------------------+-----------------------------------+--------------------+--------------------+--------------------+
| n-mhae-spi        | NEMO authentication SPI (default: | integer            | Minimum value: 0   | 256                |
|                   | 256).                             |                    | Maximum value:     |                    |
|                   |                                   |                    | 4294967295         |                    |
+-------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                   | (5 - 300, default = 5).           |                    | Maximum value: 300 |                    |
+-------------------+-----------------------------------+--------------------+--------------------+--------------------+
| reg-retry         | Maximum number of NMMO HA         | integer            | Minimum value: 1   | 3                  |
|                   | registration retries (1 to 30,    |                    | Maximum value: 30  |                    |
|                   | default = 3).                     |                    |                    |                    |
+-------------------+-----------------------------------+--------------------+--------------------+--------------------+
