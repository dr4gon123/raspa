...
|                                          | 44559).                           |                           | value: 65535              |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| scim-server-cert                         | Server certificate that the       | string                    | Maximum length: 35        |                              |
...
|                                          |                                   |                           | value: 1 \*\*             |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-devices            | Maximum number of devices allowed | integer                   | Minimum value: 84218      | 168437 \*\*                  |
|                                          | in user device store.             |                           | Maximum value: 240624     |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-unified-mem        | Maximum unified memory allowed in | integer                   | Minimum value: 168437432  | 842187161 \*\*               |
|                                          | user device store.                |                           | Maximum value: 1684374323 |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-users              | Maximum number of users allowed   | integer                   | Minimum value: 84218      | 168437 \*\*                  |
|                                          | in user device store.             |                           | Maximum value: 240624     |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
