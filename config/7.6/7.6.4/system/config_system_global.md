...
|                                          | store.                            |                           |                           |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-devices            | Maximum number of devices allowed | integer                   | Minimum value: 84219      | 168439 \*\*                  |
|                                          | in user device store.             |                           | Maximum value: 240627     |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-unified-mem        | Maximum unified memory allowed in | integer                   | Minimum value: 168439152  | 842195763 \*\*               |
|                                          | user device store.                |                           | Maximum value: 1684391526 |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-users              | Maximum number of users allowed   | integer                   | Minimum value: 84219      | 168439 \*\*                  |
|                                          | in user device store.             |                           | Maximum value: 240627     |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
