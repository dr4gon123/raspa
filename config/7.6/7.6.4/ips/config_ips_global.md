...
|                            | scanning (10 - 50, default =      |                     |                     |                     |
|                            | zero). To disable set to zero.    |                     |                     |                     |
...
|                            | |             | higher throughput than basic mode.                     |                            |
|                            | +-------------+--------------------------------------------------------+                            |
+----------------------------+-----------------------------------+---------------------+---------------------+---------------------+
...
|                            | database (1 - 2147483647, use     |                     | 2147483647          |                     |
|                            | recommended setting = 0).         |                     |                     |                     |
+----------------------------+-----------------------------------+---------------------+---------------------+---------------------+
| deep-app-insp-timeout      | Timeout for Deep application      | integer             | Minimum value: 0    | 0                   |
|                            | inspection (1 - 2147483647 sec.,  |                     | Maximum value:      |                     |
|                            | 0 = use recommended setting).     |                     | 2147483647          |                     |
+----------------------------+-----------------------------------+---------------------+---------------------+---------------------+
...
|                            | +-------------+--------------------------------------------------------+                            |
+----------------------------+-----------------------------------+---------------------+---------------------+---------------------+
| machine-learning-detection | Enable/disable machine learning   | option              | \-                  | enable              |
|                            | detection.                        |                     |                     |                     |
+----------------------------+-----------------------------------+---------------------+---------------------+---------------------+
|                            | +-------------+--------------------------------------------------------+                            |
|                            | | Option      | Description                                            |                            |
