...
|                               | pauses between successive speed   |                    | Maximum value:     |                    |
|                               | tests before trying a different   |                    | 3600               |                    |
...
|                               | schedule.                         |                    |                    |                    |
+-------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| server-name                   | Speed test server name in         | string             | Maximum length: 35 |                    |
|                               | system.speed-test-server list or  |                    |                    |                    |
|                               | leave it as empty to choose       |                    |                    |                    |
|                               | default server \"FTNT_Auto\".     |                    |                    |                    |
+-------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
