...
|                             | allowed (1 - 600000 Kbps, default |                    | Maximum value:     |                    |
|                             | = 2000).                          |                    | 600000             |                    |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                             | +-------------+--------------------------------------------------------+                         |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| call-capacity               | Maximum number of Voice over WLAN | integer            | Minimum value: 0   | 10                 |
|                             | (VoWLAN) phones allowed (0 - 60,  |                    | Maximum value: 60  |                    |
|                             | default = 10).                    |                    |                    |                    |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| comment                     | Comment.                          | string             | Maximum length: 63 |                    |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| downlink                    | Maximum downlink bandwidth for    | integer            | Minimum value: 0   | 0                  |
|                             | Virtual Access Points (VAPs) (0 - |                    | Maximum value:     |                    |
|                             | 2097152 Kbps, default = 0, 0      |                    | 2097152            |                    |
|                             | means no limit).                  |                    |                    |                    |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| downlink-sta                | Maximum downlink bandwidth for    | integer            | Minimum value: 0   | 0                  |
|                             | clients (0 - 2097152 Kbps,        |                    | Maximum value:     |                    |
|                             | default = 0, 0 means no limit).   |                    | 2097152            |                    |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                             | access (default = 0).             |                    | Maximum value: 63  |                    |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| wmm-bk-dscp                 | DSCP marking for background       | integer            | Minimum value: 0   | 8                  |
|                             | access (default = 8).             |                    | Maximum value: 63  |                    |
+-----------------------------+-----------------------------------+--------------------+--------------------+--------------------+
