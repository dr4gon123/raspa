...
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
| user-device-store-max-unified-mem        | Maximum unified memory allowed in | integer                   | Minimum value: 168438988  | 842194944 \*\*               |
|                                          | user device store.                |                           | Maximum value: 1684389888 |                              |
|                                          |                                   |                           | \*\*                      |                              |
+------------------------------------------+-----------------------------------+---------------------------+---------------------------+------------------------------+
