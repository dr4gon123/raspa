...
|                          |                                   |        | 47      |                        |
+--------------------------+-----------------------------------+--------+---------+------------------------+
| diameter-filter-profile  | Name of an existing Diameter      | string | Maximum |                        |
|                          | filter profile.                   |        | length: |                        |
|                          |                                   |        | 47      |                        |
+--------------------------+-----------------------------------+--------+---------+------------------------+
...
|                          |                                   |        | 47      |                        |
+--------------------------+-----------------------------------+--------+---------+------------------------+
| telemetry-profile \*     | Name of an existing telemetry     | string | Maximum |                        |
|                          | profile.                          |        | length: |                        |
|                          |                                   |        | 47      |                        |
+--------------------------+-----------------------------------+--------+---------+------------------------+
...
|                          |                                   |        | 47      |                        |
+--------------------------+-----------------------------------+--------+---------+------------------------+
| virtual-patch-profile    | Name of an existing virtual-patch | string | Maximum |                        |
|                          | profile.                          |        | length: |                        |
|                          |                                   |        | 47      |                        |
+--------------------------+-----------------------------------+--------+---------+------------------------+
