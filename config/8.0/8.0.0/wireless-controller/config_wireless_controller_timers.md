...
|                            |                                   |         | 3600       |         |
+----------------------------+-----------------------------------+---------+------------+---------+
| keep-alive-interval \*     | Time between data keep alive      | integer | Minimum    | 0       |
|                            | message sent by the managed WTP,  |         | value: 0   |         |
|                            | AP, or FortiAP (1 - 255 sec,      |         | Maximum    |         |
|                            | default = 0 which means the       |         | value: 255 |         |
|                            | interval is derived from the      |         |            |         |
|                            | echo-interval setting).           |         |            |         |
+----------------------------+-----------------------------------+---------+------------+---------+
| max-retransmit-interval \* | Maximal time to retransmit a      | integer | Minimum    | 0       |
|                            | control packet by the managed     |         | value: 2   |         |
|                            | WTP, AP, or FortiAP (2 - 255 sec, |         | Maximum    |         |
|                            | default = 0 which means the       |         | value: 255 |         |
|                            | interval is derived from the      |         |            |         |
|                            | echo-interval setting).           |         |            |         |
+----------------------------+-----------------------------------+---------+------------+---------+
