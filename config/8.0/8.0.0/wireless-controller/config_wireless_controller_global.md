...
|                               | 224.0.1.140).                     |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| discovery-mc-addr6            | Multicast IPv6 address for AP     | ipv6-address           | Not Specified        | ff02::18c            |
|                               | discovery (default = FF02::18C).  |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| fiapp-eth-type                | Ethernet type for Fortinet        | integer                | Minimum value: 0     | 5252                 |
|                               | Inter-Access Point Protocol       |                        | Maximum value: 65535 |                      |
|                               | (IAPP), or IEEE 802.11f, packets  |                        |                      |                      |
|                               | (0 - 65535, default = 5252).      |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
...
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-ble-device                | Maximum number of BLE devices     | integer                | Minimum value: 0     | 0                    |
|                               | stored on the controller (default |                        | Maximum value:       |                      |
|                               | = 0).                             |                        | 4294967295           |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-clients                   | Maximum number of clients that    | integer                | Minimum value: 0     | 0                    |
|                               | can connect simultaneously        |                        | Maximum value:       |                      |
|                               | (default = 0, meaning no          |                        | 4294967295           |                      |
|                               | limitation).                      |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-retransmit                | Maximum number of tunnel packet   | integer                | Minimum value: 0     | 3                    |
|                               | retransmissions (0 - 64, default  |                        | Maximum value: 64    |                      |
|                               | = 3).                             |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-rogue-ap                  | Maximum number of rogue APs       | integer                | Minimum value: 0     | 0                    |
|                               | stored on the controller (default |                        | Maximum value:       |                      |
|                               | = 0).                             |                        | 4294967295           |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-rogue-ap-wtp              | Maximum number of rogue AP\'s wtp | integer                | Minimum value: 1     | 16                   |
|                               | info stored on the controller     |                        | Maximum value: 16    |                      |
|                               | (1 - 16, default = 16).           |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-rogue-sta                 | Maximum number of rogue stations  | integer                | Minimum value: 0     | 0                    |
|                               | stored on the controller (default |                        | Maximum value:       |                      |
|                               | = 0).                             |                        | 4294967295           |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-sta-cap                   | Maximum number of station cap     | integer                | Minimum value: 0     | 0                    |
|                               | stored on the controller (default |                        | Maximum value:       |                      |
|                               | = 0).                             |                        | 4294967295           |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-sta-cap-wtp               | Maximum number of station cap\'s  | integer                | Minimum value: 1     | 8                    |
|                               | wtp info stored on the controller |                        | Maximum value: 8     |                      |
|                               | (1 - 16, default = 8).            |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-sta-offline               | Maximum number of station offline | integer                | Minimum value: 0     | 0                    |
|                               | stored on the controller (default |                        | Maximum value:       |                      |
|                               | = 0).                             |                        | 4294967295           |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-sta-offline-ip2mac        | Maximum number of station offline | integer                | Minimum value: 0     | 0                    |
|                               | ip2mac stored on the controller   |                        | Maximum value:       |                      |
|                               | (default = 0).                    |                        | 4294967295           |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-vap-per-radio \*          | Maximum number of SSIDs supported | option                 | \-                   | 8                    |
|                               | on the radio (default = 8).       |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
|                               | +-------------+--------------------------------------------------------+                                 |
|                               | | Option      | Description                                            |                                 |
|                               | +=============+========================================================+                                 |
|                               | | *8*         | Support at most 8 SSIDs on the radio.                  |                                 |
|                               | +-------------+--------------------------------------------------------+                                 |
|                               | | *16*        | Support at most 16 SSIDs on the radio.                 |                                 |
|                               | +-------------+--------------------------------------------------------+                                 |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| max-wids-entry                | Maximum number of wids entries    | integer                | Minimum value: 0     | 0                    |
|                               | stored on the controller (default |                        | Maximum value:       |                      |
|                               | = 0).                             |                        | 4294967295           |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| mesh-eth-type                 | Mesh Ethernet identifier included | integer                | Minimum value: 0     | 8755                 |
|                               | in backhaul packets (0 - 65535,   |                        | Maximum value: 65535 |                      |
|                               | default = 8755).                  |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
| nac-interval                  | Interval in seconds between two   | integer                | Minimum value: 10    | 120                  |
|                               | WiFi network access control (NAC) |                        | Maximum value: 600   |                      |
|                               | checks (10 - 600, default = 120). |                        |                      |                      |
+-------------------------------+-----------------------------------+------------------------+----------------------+----------------------+
