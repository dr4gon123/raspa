...
|                          | calculation for channel load (0 - |                    | Maximum value: 200 |                    |
|                          | 200, default = 20).               |                    | \*\*               |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| weight-dfs-channel       | Weight in DARRP channel score     | integer            | Minimum value: 0   | 50 \*\*            |
|                          | calculation for DFS channel (0 -  |                    | Maximum value: 200 |                    |
|                          | 200, default = 50).               |                    | \*\*               |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| weight-managed-ap        | Weight in DARRP channel score     | integer            | Minimum value: 0   | 50                 |
|                          | calculation for managed APs (0 -  |                    | Maximum value: 200 |                    |
|                          | 200, default = 50).               |                    | \*\*               |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| weight-noise-floor       | Weight in DARRP channel score     | integer            | Minimum value: 0   | 40                 |
|                          | calculation for noise floor (0 -  |                    | Maximum value: 200 |                    |
|                          | 200, default = 40).               |                    | \*\*               |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| weight-rogue-ap          | Weight in DARRP channel score     | integer            | Minimum value: 0   | 0 \*\*             |
|                          | calculation for rogue APs (0 -    |                    | Maximum value: 200 |                    |
|                          | 200, default = 0).                |                    | \*\*               |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| weight-spectral-rssi     | Weight in DARRP channel score     | integer            | Minimum value: 0   | 40                 |
|                          | calculation for spectral RSSI     |                    | Maximum value: 200 |                    |
|                          | (0 - 200, default = 40).          |                    | \*\*               |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| weight-weather-channel   | Weight in DARRP channel score     | integer            | Minimum value: 0   | 100 \*\*           |
|                          | calculation for weather channel   |                    | Maximum value: 200 |                    |
|                          | (0 - 200, default = 100).         |                    | \*\*               |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
