...
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| default-mesh-root                   | Configure default mesh root SSID  | option                 | \-                     | disable                              |
|                                     | when it is not included by        |                        |                        |                                      |
...
|                                     | +-------------+--------------------------------------------------------+                                                   |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| index                               | Index (0 - 4294967295).           | integer                | Minimum value: 0       | 0                                    |
|                                     | Read-only.                        |                        | Maximum value:         |                                      |
|                                     |                                   |                        | 4294967295             |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| ip-fragment-preventing              | Method(s) by which IP             | option                 | \-                     | tcp-mss-adjust                       |
|                                     | fragmentation is prevented for    |                        |                        |                                      |
|                                     | control and data packets through  |                        |                        |                                      |
|                                     | CAPWAP tunnel (default =          |                        |                        |                                      |
|                                     | tcp-mss-adjust).                  |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
|                                     | +--------------------+--------------------------------------------------------+                                            |
|                                     | | Option             | Description                                            |                                            |
...
|                                     | +-------------+--------------------------------------------------------+                                                   |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| override-default-mesh-root          | Enable to override the WTP        | option                 | \-                     | disable                              |
|                                     | profile default mesh root SSID    |                        |                        |                                      |
|                                     | setting.                          |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
|                                     | +-------------+--------------------------------------------------------+                                                   |
|                                     | | Option      | Description                                            |                                                   |
|                                     | +=============+========================================================+                                                   |
|                                     | | *enable*    | Override the WTP profile default mesh root SSID        |                                                   |
|                                     | |             | setting.                                               |                                                   |
|                                     | +-------------+--------------------------------------------------------+                                                   |
...
|                                     | +-------------+--------------------------------------------------------+                                                   |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| static-lowi \*                      | Enable/disable static LOWI        | option                 | \-                     | disable                              |
|                                     | position of the FortiAP.          |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
|                                     | +-------------+--------------------------------------------------------+                                                   |
|                                     | | Option      | Description                                            |                                                   |
|                                     | +=============+========================================================+                                                   |
|                                     | | *enable*    | Enable static LOWI position of the FortiAP.            |                                                   |
|                                     | +-------------+--------------------------------------------------------+                                                   |
|                                     | | *disable*   | Disable static LOWI position of the FortiAP.           |                                                   |
|                                     | +-------------+--------------------------------------------------------+                                                   |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| static-lowi-alt \*                  | Static LOWI altitude position of  | integer                | Minimum value: 0       | 0                                    |
|                                     | the AP (between 0 and 500         |                        | Maximum value: 500     |                                      |
|                                     | meters).                          |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| static-lowi-alt-err \*              | Static LOWI altitude error of the | integer                | Minimum value: 0       | 0                                    |
|                                     | AP (between 0 and 50 meters).     |                        | Maximum value: 50      |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| static-lowi-lat \*                  | Static LOWI latitude position of  | string                 | Maximum length: 15     | 0                                    |
|                                     | the AP (between -90 and 90        |                        |                        |                                      |
|                                     | degrees).                         |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| static-lowi-lat-err \*              | Static LOWI latitude error of the | integer                | Minimum value: 0       | 0                                    |
|                                     | AP (between 0 and 50 meters).     |                        | Maximum value: 50      |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| static-lowi-lon \*                  | Static LOWI longitude position of | string                 | Maximum length: 15     | 0                                    |
|                                     | the AP (between -180 and 180      |                        |                        |                                      |
|                                     | degrees).                         |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| static-lowi-lon-err \*              | Static LOWI longitude error of    | integer                | Minimum value: 0       | 0                                    |
|                                     | the AP (between 0 and 50 meters). |                        | Maximum value: 50      |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| tun-mtu-downlink                    | The MTU of downlink CAPWAP tunnel | integer                | Minimum value: 576     | 0                                    |
|                                     | (576 - 1500 bytes or 0; 0 means   |                        | Maximum value: 1500    |                                      |
|                                     | the local MTU of FortiAP; default |                        |                        |                                      |
|                                     | = 0).                             |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
| tun-mtu-uplink                      | The maximum transmission unit     | integer                | Minimum value: 576     | 0                                    |
|                                     | (MTU) of uplink CAPWAP tunnel     |                        | Maximum value: 1500    |                                      |
|                                     | (576 - 1500 bytes or 0; 0 means   |                        |                        |                                      |
|                                     | the local MTU of FortiAP; default |                        |                        |                                      |
|                                     | = 0).                             |                        |                        |                                      |
+-------------------------------------+-----------------------------------+------------------------+------------------------+--------------------------------------+
