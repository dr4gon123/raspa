...
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
| match-period          | Duration in hours to retain the   | integer              | Minimum value: 0     | 0                    |
|                       | matched devices (0 - 3072, 0 =    |                      | Maximum value: 3072  |                      |
|                       | always retain).                   |                      | \*\*                 |                      |
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
| match-remove          | Options to remove the matched     | option               | \-                   | default              |
|                       | override devices.                 |                      |                      |                      |
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
|                       | +-------------+--------------------------------------------------------+                               |
|                       | | Option      | Description                                            |                               |
|                       | +=============+========================================================+                               |
|                       | | *default*   | Remove the matched override devices based on the match |                               |
|                       | |             | period.                                                |                               |
|                       | +-------------+--------------------------------------------------------+                               |
|                       | | *link-down* | Remove the matched override devices based on switch    |                               |
...
|                       | system.                           |                      |                      |                      |
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
| port-setting-override | Enable/disable port setting       | option               | \-                   | disable              |
| \*                    | action on the NAC policy.         |                      |                      |                      |
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
|                       | +-------------+--------------------------------------------------------+                               |
|                       | | Option      | Description                                            |                               |
|                       | +=============+========================================================+                               |
|                       | | *disable*   | Disable port setting action on the nac-policy.         |                               |
|                       | +-------------+--------------------------------------------------------+                               |
|                       | | *enable*    | Enable port setting action and apply if matched device |                               |
|                       | |             | is the only device on the port.                        |                               |
|                       | +-------------+--------------------------------------------------------+                               |
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
| qos-policy \*         | Switch Port qos-policy action to  | string               | Maximum length: 63   |                      |
|                       | be applied on the matched NAC     |                      |                      |                      |
|                       | policy.                           |                      |                      |                      |
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
...
+-----------------------+-----------------------------------+----------------------+----------------------+----------------------+
| switch-group `<name>` | List of managed FortiSwitch       | string               | Maximum length: 79   |                      |
|                       | groups on which NAC policy can be |                      |                      |                      |
|                       | applied.                          |                      |                      |                      |
|                       |                                   |                      |                      |                      |
