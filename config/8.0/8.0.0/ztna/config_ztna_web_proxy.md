    ...
    edit <name>
        config api-gateway
            ...
            edit <id>
                ...
                config realservers
                    Description: Select the real servers that this ZTNA web-proxy will distribute traffic to.
                    edit <id>
...
|                                        | +-------------+--------------------------------------------------------+                         |
+----------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| name                                   | ZTNA web proxy name.              | string             | Maximum length: 79 |                    |
+----------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| svr-pool-multiplex \*                  | Enable/disable server pool        | option             | \-                 | disable            |
|                                        | multiplexing (default = disable). |                    |                    |                    |
|                                        | Share connected server in HTTP    |                    |                    |                    |
|                                        | and HTTPS api-gateways.           |                    |                    |                    |
+----------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
|                                        | +-------------+--------------------------------------------------------+                         |
|                                        | | Option      | Description                                            |                         |
|                                        | +=============+========================================================+                         |
