...
+==========================+===================================+====================+====================+====================+
| login-page               | Replacement HTML for Agentless    | var-string         | Maximum length:    |                    |
|                          | VPN login page.                   |                    | 32768              |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| max-concurrent-user      | Maximum concurrent users (0 -     | integer            | Minimum value: 0   | 0                  |
|                          | 65535, 0 means unlimited).        |                    | Maximum value:     |                    |
|                          |                                   |                    | 65535              |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                          | server.                           |                    |                    |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| radius-port              | RADIUS service port number (0 -   | integer            | Minimum value: 0   | 0                  |
|                          | 65535, 0 means                    |                    | Maximum value:     |                    |
|                          | user.radius.radius-port).         |                    | 65535              |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| radius-server            | RADIUS server associated with     | string             | Maximum length: 35 |                    |
|                          | realm.                            |                    |                    |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| url-path                 | URL path to access Agentless VPN  | string             | Maximum length: 35 |                    |
|                          | login page.                       |                    |                    |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                          | virtual host method for Agentless |                    |                    |                    |
|                          | VPN client access.                |                    |                    |                    |
+--------------------------+-----------------------------------+--------------------+--------------------+--------------------+
|                          | +-------------+--------------------------------------------------------+                         |
|                          | | Option      | Description                                            |                         |
