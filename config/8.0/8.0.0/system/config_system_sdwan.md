...
config system sdwan
    ...
    config neighbor
        Description: Create SD-WAN neighbors from BGP neighbor table to control route advertisements according to SLA status.
        edit <ip>
...
|                             | 0).                               |                       |                       |                       |
+-----------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
| duplication-max-discrepancy | Maximum discrepancy between two   | integer               | Minimum value: 250    | 250                   |
|                             | packets for deduplication in      |                       | Maximum value: 1000   |                       |
|                             | milliseconds (250 - 1000, default |                       |                       |                       |
|                             | = 250).                           |                       |                       |                       |
+-----------------------------+-----------------------------------+-----------------------+-----------------------+-----------------------+
