...
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| password                | HTTP basic authentication         | varlen_password       | Not Specified         |                                      |
|                         | password.                         |                       |                       |                                      |
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| refresh-rate            | Time interval to refresh external | integer               | Minimum value: 1      | 5                                    |
|                         | resource (1 - 43200 min, default  |                       | Maximum value: 43200  |                                      |
|                         | = 5 min).                         |                       |                       |                                      |
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
...
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| source-ip-interface     | IPv4 Source interface for         | string                | Maximum length: 15    |                                      |
...
|                         | +-------------+--------------------------------------------------------+                                                 |
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| threat-feed-hash-mode   | Configure use of the external     | option                | \-                    | plain-text-db                        |
| \*                      | threat feed as either a hash      |                       |                       |                                      |
|                         | database or plain text database   |                       |                       |                                      |
|                         | (default = plain-text-db).        |                       |                       |                                      |
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
|                         | +-----------------+--------------------------------------------------------+                                             |
|                         | | Option          | Description                                            |                                             |
|                         | +=================+========================================================+                                             |
...
|                         | +-------------+--------------------------------------------------------+                                                 |
|                         | | *fortimq*   | External resource update is pushed to the FortiGate    |                                                 |
|                         | |             | unit through the Fortinet Message Queue fabric.        |                                                 |
|                         | +-------------+--------------------------------------------------------+                                                 |
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
| user-agent              | HTTP User-Agent header (default = | var-string            | Maximum length: 255   |                                      |
|                         | \'curl/7.58.0\').                 |                       |                       |                                      |
+-------------------------+-----------------------------------+-----------------------+-----------------------+--------------------------------------+
