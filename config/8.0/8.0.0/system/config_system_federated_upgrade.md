...
config system federated-upgrade
    ...
    set ignore-signing-errors [enable|disable]
    ...
    config node-list
        ...
        edit <serial>
            set allow-download [enable|disable]
...
|                       | +-----------------------------+--------------------------------------------------------+                     |
|                       | | *image-missing*             | The firmware image is missing and download is not      |                     |
|                       | |                             | allowed                                                |                     |
|                       | +-----------------------------+--------------------------------------------------------+                     |
|                       | | *suspension-timeout*        | The upgrade timed out while suspended due to system    |                     |
|                       | |                             | state.                                                 |                     |
|                       | +-----------------------------+--------------------------------------------------------+                     |
+-----------------------+-----------------------------------+------------------------+------------------------+------------------------+
...
|                       | of the HA cluster.                |                        |                        |                        |
+-----------------------+-----------------------------------+------------------------+------------------------+------------------------+
| ignore-signing-errors | Allow/reject use of FortiGate     | option                 | \-                     | disable                |
|                       | firmware images that are          |                        |                        |                        |
|                       | unsigned.                         |                        |                        |                        |
+-----------------------+-----------------------------------+------------------------+------------------------+------------------------+
|                       | +-------------+--------------------------------------------------------+                                     |
|                       | | Option      | Description                                            |                                     |
