...
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| additional-path-select-vpnv6        | Number of additional paths to be  | integer            | Minimum value: 2   | 2                  |
|                                     | selected for each VPNv6 NLRI.     |                    | Maximum value: 255 |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                                     | +-------------+--------------------------------------------------------+                         |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| additional-path-vpnv6               | Enable/disable selection of BGP   | option             | \-                 | disable            |
|                                     | VPNv6 additional paths.           |                    |                    |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
|                                     | +-------------+--------------------------------------------------------+                         |
|                                     | | Option      | Description                                            |                         |
|                                     | +=============+========================================================+                         |
...
|                                     | penalty (min).                    |                    | Maximum value: 45  |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| dampening6 \*                       | Enable/disable IPv6 route-flap    | option             | \-                 | disable            |
|                                     | dampening.                        |                    |                    |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
|                                     | +-------------+--------------------------------------------------------+                         |
|                                     | | Option      | Description                                            |                         |
...
|                                     | +-------------+--------------------------------------------------------+                         |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| dampening6-max-suppress-time \*     | Maximum minutes an IPv6 route can | integer            | Minimum value: 1   | 60                 |
|                                     | be suppressed.                    |                    | Maximum value: 255 |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| dampening6-reachability-half-life   | IPv6 reachability half-life time  | integer            | Minimum value: 1   | 15                 |
| \*                                  | for penalty (min).                |                    | Maximum value: 45  |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| dampening6-reuse \*                 | Threshold to reuse IPv6 routes.   | integer            | Minimum value: 1   | 750                |
|                                     |                                   |                    | Maximum value:     |                    |
|                                     |                                   |                    | 20000              |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| dampening6-route-map \*             | Criteria for IPv6 dampening.      | string             | Maximum length: 35 |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| dampening6-suppress \*              | Threshold to suppress IPv6        | integer            | Minimum value: 1   | 2000               |
|                                     | routes.                           |                    | Maximum value:     |                    |
|                                     |                                   |                    | 20000              |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| dampening6-unreachability-half-life | IPv6 unreachability half-life     | integer            | Minimum value: 1   | 15                 |
| \*                                  | time for penalty (min).           |                    | Maximum value: 45  |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                                     | +-------------+--------------------------------------------------------+                         |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
| display-options \*                  | Display options for Router AS     | integer            | Minimum value: 0   | 0                  |
|                                     | number Read-only.                 |                    | Maximum value:     |                    |
|                                     |                                   |                    | 4294967295         |                    |
+-------------------------------------+-----------------------------------+--------------------+--------------------+--------------------+
...
|                                     | |             | hops of tag-match whose interfaces or child interfaces |                         |
|                                     | |             | have appeared in best-match.                           |                         |
|                                     | +-------------+--------------------------------------------------------+                         |
|                                     | | *merge-all* | Merge tag-match with best-match if they are using      |                         |
|                                     | |             | different routes. The result will exclude the next     |                         |
